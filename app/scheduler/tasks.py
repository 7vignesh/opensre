...
def _build_daily_summary(task: ScheduledTask) -> str:
    ...
    if pipeline_failed:
        return (
            ...
            f"⚠️ Pipeline unavailable — unable to assess system health.\n"
            f"Check integration connectivity and retry.\n\n"
...
def _build_weekly_audit(task: ScheduledTask) -> str:
    ...
    if pipeline_failed:
        return (
            ...
            f"⚠️ Pipeline unavailable — unable to produce alert audit.\n"
            f"Check integration connectivity and retry.\n\n"
            f"<i>Generated by OpenSRE scheduled delivery</i>"
        )
